...
const showResult = () => {
  ...
  resultScreen.querySelector(".score").textContent = `Score: ${correctCount} / ${total}`;
};
...
const showQuestion = (qNumber) => {
  ...
  answersContainer.innerHTML = data[qNumber].answers
    ...
    `
      <div class="answer">
        <input type="radio" name="anwswer" id=${index} value=${item.isCorrect} />
...
const submitAnswer = () => {
  submit.addEventListener("click", () => {
    if(selectedAnswer !== null){
      ...
      qIndex++;
      showQuestion(qIndex);
    } else alert("Alert Select an answer");
  });
};
